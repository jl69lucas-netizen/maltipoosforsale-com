...
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-7632fe8a' );
});
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-88d7a257' );
});
...
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-958c10cf' );
});
window.addEventListener( 'load', function() {
	UAGBButtonChild.init( '.uagb-block-797aba87' );
});
 });